    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed left-4 top-4 z-50 flex h-10 w-10 items-center justify-center rounded-xl bg-paper shadow-kinetic md:hidden"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-64 flex-col bg-paper p-6 shadow-kinetic transition-transform duration-300 ease-in-out md:translate-x-0 ${
      ...
      >
        ...
        <div className="mb-10 flex items-center justify-between px-2">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-magenta shadow-kinetic-primary">
              <span className="font-headline text-base font-black text-white">JA</span>
            </div>
            <div>
              <h1 className="font-headline text-sm font-extrabold leading-none tracking-tight text-ink">
                Jime Agorreca
              </h1>
          ...
          <button
            onClick={() => setIsOpen(false)}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-ink-muted transition-colors hover:text-ink md:hidden"
        ...
        <div className="mt-auto space-y-2 pt-6">
          <div className="rounded-xl p-4" style={{ background: 'var(--cream)', border: '1px solid var(--line)' }}>
            <p className="mb-2 font-mono text-[10px] font-bold uppercase tracking-widest text-ink-muted">
              Soporte
            </p>
            <Button
              variant="ghost"
              size="sm"
              className="w-full justify-start px-0 font-body font-semibold text-magenta hover:bg-transparent hover:text-magenta-deep"
            >
          ...
          <Button
            ...
            className="w-full justify-start px-4 font-body font-semibold text-ink-muted hover:bg-destructive/[0.06] hover:text-destructive"
          >
